  ...
  List<Article> getArticles() {
    return [
      Article(
        ...
        title: 'Como Chegar',
        icon: '✈️',
        content: 'Fernando de Noronha é acessível por voos diretos de Recife (1h) e Natal (1h30). As principais companhias aéreas que operam são Azul e Gol. Reserve com antecedência para melhores preços!',
      ...
      Article(
        ...
        title: 'Quando Ir',
        icon: '📅',
        content: 'A melhor época é entre agosto e fevereiro, com mar calmo e ótima visibilidade. De dezembro a março é temporada de chuvas, mas ainda vale a pena. Evite junho e julho se busca mergulho.',
      ...
      Article(
        ...
        title: 'Onde Ficar',
        icon: '🏨',
        content: 'As principais opções são Vila dos Remédios (centro), Floresta Nova e Boldró. Pousadas variam de R\$300 a R\$2000/dia. Reserve com meses de antecedência na alta temporada.',
      ...
      Article(
        ...
        title: 'Onde Comer',
        icon: '🍽️',
        content: 'Experimente os restaurantes da Vila dos Remédios. Destaque para frutos do mar frescos. Média de R\$80-150 por pessoa. Não perca o pôr do sol no Bar do Meio!',
        imageUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0',
      ...
      Article(
        ...
        title: 'Praias',
        icon: '🏖️',
        content: 'Principais: Baía do Sancho (melhor do mundo), Baía dos Porcos, Praia do Leão, Cacimba do Padre. Mar de Dentro (calmo) e Mar de Fora (ondas).',
        imageUrl: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19',
        category: 'Atrações',
      ),
      Article(
        ...
        title: 'Passeios',
        icon: '🚤',
        content: 'Imperdíveis: Ilha Tour, Passeio de Barco, Mergulho, Trilha do Atalaia. Agende com antecedência, especialmente o Atalaia (limitado).',
        imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5',
        category: 'Atrações',
      ),
      Article(
        ...
        title: 'Taxas',
        icon: '💰',
        content: 'Taxa de Preservação Ambiental: R\$79,20/dia (máx 10 dias). Ingresso PARNAMAR: R\$222 (válido 10 dias). Cartão de vacina febre amarela obrigatório.',
        imageUrl: 'https://images.unsplash.com/photo-1554224311-beee4ece0ec7',
        category: 'Planejamento',
      ),
      Article(
        id: 'dicas',
        ...
        icon: '💡',
        content: 'Leve protetor solar, repelente, máscara de mergulho. Não há caixas eletrônicos de todos os bancos. Leve dinheiro. Internet limitada. Aproveite para desconectar!',
      ...
      Article(
        ...
        title: 'Trilhas',
        icon: '🥾',
        content: 'Principais trilhas: Atalaia (agendamento obrigatório), Costa Esmeralda, Capim-Açu, Mirante dos Golfinhos. Use tênis adequado e leve água.',
        imageUrl: 'https://images.unsplash.com/photo-1551632811-561732d1e306',
        category: 'Atrações',
      ),
      Article(
        ...
        title: 'Quanto Custa',
        icon: '💵',
        content: 'Média 7 dias: Passagem R\$1500-3000, Hospedagem R\$2100-14000, Alimentação R\$1400, Passeios R\$1500, Taxas R\$800. Total: R\$7300-20700.',
      ...
      Article(
        ...
        title: 'Vida Noturna',
        icon: '🎉',
        content: 'Opções limitadas mas charmosas. Bares na Vila dos Remédios. Bar do Cachorro é o mais famoso. Forró e MPB. Ambiente descontraído e familiar.',
      ...
      Article(
        ...
        icon: '🚗',
        content: 'Aluguel de buggy (R\$250-400/dia), carro (R\$700-1090/dia), moto (R\$150-250/dia), bike elétrica (R\$100/dia). Táxis disponíveis. Ônibus limitado.',
